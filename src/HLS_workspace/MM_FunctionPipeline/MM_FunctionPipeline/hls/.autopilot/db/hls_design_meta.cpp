...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("res_address1", 4, hls_out, 6, "ap_memory", "MemPortADDR2", 1),
	Port_Property("res_ce1", 1, hls_out, 6, "ap_memory", "MemPortCE2", 1),
	Port_Property("res_we1", 1, hls_out, 6, "ap_memory", "MemPortWE2", 1),
	Port_Property("res_d1", 16, hls_out, 6, "ap_memory", "MemPortDIN2", 1),
};
